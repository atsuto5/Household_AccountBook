...
public class EntertainmentFragment extends Fragment {
    ...
    private String url = "http://news.yahoo.co.jp/pickup/entertainment/rss.xml";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRssAdapter = new RssAdapter(mMainActivity, R.layout.rss_beans, PrefsUtils.ENTERTAINMENT_KEY);

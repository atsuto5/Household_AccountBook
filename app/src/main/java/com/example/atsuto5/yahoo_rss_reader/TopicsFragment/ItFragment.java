...
public class ItFragment extends Fragment {
    ...
    private String url = "http://news.yahoo.co.jp/pickup/computer/rss.xml";

    public static ItFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRssAdapter = new RssAdapter(mMainActivity, R.layout.rss_beans, PrefsUtils.IT_KEY);
